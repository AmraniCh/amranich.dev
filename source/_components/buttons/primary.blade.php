...
<button type="{{ isset($submit) ? 'submit' : 'button' }}" class="group relative primary-btn">
    ...
    <span
        class="flex justify-center items-center gap-2 uppercase script-font fold-normal relative h-full w-full rounded bg-yellow-800 px-3 py-1 md:px-6 md:py-2 text-base text-white transition duration-100 dark:bg-yellow-200 dark:text-yellow-900 dark:border-none">
