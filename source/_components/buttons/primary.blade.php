...
<button type="{{ isset($submit) ? 'submit' : 'button' }}"
    {{ $attributes->merge(['class' => 'group relative primary-btn']) }}>
    <span
    ...
    <span
        ...
        <svg class="spinner hidden w-4 h-4 me-2 animate-spin" aria-hidden="true" role="status" viewBox="0 0 100 101"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path class="fill-white dark:fill-yellow-900"
