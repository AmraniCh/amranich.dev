<button type="{{ isset($submit) ? 'submit' : 'button' }}" class="group relative primary-btn">
    ...
    <span
        class="uppercase font-bold relative inline-block h-full w-full rounded border-2 border-yellow-900 bg-yellow-900 px-3 py-1  md:px-6 md:py-2 text-base text-white transition duration-100 group-hover:bg-yellow-50 group-hover:text-yellow-900 dark:bg-transparent dark:border-yellow-400">
