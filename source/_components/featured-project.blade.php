<div class="{{ isset($highlight) ? 'bg-yellow-100 p-4 rounded-md' : '' }}">
    <div
        class="group flex flex-col w-full text-yellow-900  {{ !isset($highlight) ? 'grayscale hover:grayscale-0 dark:text-yellow-200' : '' }} transition-all lg:flex-row lg:gap-10">
        <!-- Project Snapshot -->
        <div class="lg:flex lg:items-center lg:flex-shrink-0">
            <img class="w-full lg:w-[500px] xl:w-[600px] rounded-md" src="/assets/images/{{ $snapshot }}"
                alt="El Amrani Chakir's personal webiste snapshot">
        </div>
        <div class="mt-3 lg:flex lg:flex-col lg:justify-center">
            ...
            <!-- Title -->
            <h5 class="mt-2 capitalize">{!! $title !!}</h5>
            ...
            <div class="flex justify-center gap-4 lg:justify-start">
                <x-buttons.link text="source">
                    ...
                    <svg class="{{ !isset($highlight) ? 'dark:fill-yellow-200' : '' }} fill-yellow-900"
                        xmlns="http://www.w3.org/2000/svg" height="16" width="15.5"
