...
@section('body')
    <div
        class="container relative bg-yellow-50 max-w-7xl m-auto pt-4 rounded-b-xl overflow-hidden md:rounded-xl md:border-4 md:border-yellow-800 lg:pt-8 dark:bg-dark dark:border-yellow-200">
