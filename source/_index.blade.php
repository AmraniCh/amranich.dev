    ...
    <div class="bg-yellow p-8 h-full">
        <div class="bg-glass bg-no-repeat bg-fit flex justify-center items-center h-full relative rounded-lg drop-shadow-lg">
            <div class="flex flex-col justify-center items-center text-yellow-900">
                ...
                <img class="rounded-full mb-2 w-40" src="/assets/images/me.png" alt="El Amrani Chakir">
                <h1 class="text-xl tracking-widest sm:text-2xl">amranich.dev</h1>
                <p class="text-3xl py-3 font-bold text-brown text-center tracking-widest sm:text-6xl sm:py-4">COMING SOON..</p>
