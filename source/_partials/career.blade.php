<div id="career-section" class="section career-section scroll-spy-indicator-subscriber"
    ...
    <div class="relative flex flex-col gap-2">
        <x-career-card style="animation-delay: .1s" title="{{ $page->trans('career.5-position.title') }}"
            ...
            logo="{{ $page->trans('career.5-position.location') }}" logoUrl="/assets/images/the-linux-foundation-logo.jpg"
    ...
    <div class="career-education relative flex flex-col gap-2 mt-4 lg:grid lg:grid-cols-2">
        <x-career-card style="animation-delay: .5s" title="{{ $page->trans('career.2-education.title') }}"
        ...
        <x-career-card style="animation-delay: .6s" title="{{ $page->trans('career.1-education.title') }}"
            ...
            logo="{{ $page->trans('career.1-education.location') }}" logoUrl="/assets/images/university-uae-logo.jpg"
