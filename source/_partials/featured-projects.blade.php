<div id="projects-section" class="section projects-section scroll-spy-indicator-subscriber"
    ...
    <div class="flex flex-col gap-10 lg:gap-16 xl:gap-24">
        ...
        <div
            class="tip flex flex-col gap-4 p-4 bg-white border border-dashed border-yellow-800 rounded-lg lg:flex-row lg:items-center dark:bg-dark dark:border-yellow-200">
            <div class="lg:flex md:items-center md:gap-2">
                <svg class="inline w-6 h-6 shrink-0 fill-yellow-400 lg:w-10 lg:h-10 dark:fill-yellow-200"
