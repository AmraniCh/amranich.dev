                ...
                <ul class="flex items-center gap-3 mt-3">
                    <li>
                        <a href="{{ $page->links->github }}" target="_blank">
                            <svg class="group w-8 h-8 hover:scale-110" viewBox="0 0 30 31"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    class="fill-brown-700 group-hover:fill-none group-hover:stroke group-hover:stroke-yellow-900 dark:fill-yellow-200 dark:group-hover:fill-none dark:group-hover:stroke dark:group-hover:stroke-yellow-200"
                    ...
                    <li>
                        <a href="{{ $page->links->stackoverflow }}" target="_blank">
                            ...
                            <svg class="group w-8 h-8 hover:scale-110" viewBox="0 0 26 27" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    class="fill-brown-700 group-hover:fill-none group-hover:stroke group-hover:stroke-yellow-900 dark:fill-yellow-200 dark:group-hover:fill-none dark:group-hover:stroke dark:group-hover:stroke-yellow-200"
                                    d="M2.78571 0C1.24777 0 0 1.25977 0 2.8125V23.4375C0 24.9902 1.24777 26.25 2.78571 26.25H23.2143C24.7522 26.25 26 24.9902 26 23.4375V2.8125C26 1.25977 24.7522 0 23.2143 0H2.78571ZM15.9057 3.75L20.8382 10.4619L19.5087 11.4578L14.5764 4.74592L15.9057 3.75ZM12.8394 6.43488L19.2085 11.7826L18.1575 13.0601L11.7885 7.71193L12.8394 6.43488ZM10.3945 9.899L17.9004 13.4496L17.2143 14.9652L9.7085 11.4362L10.3945 9.899ZM8.97929 13.6881L17.0854 15.3982L16.7422 17.0441L8.63629 15.3334L8.97929 13.6881ZM5.1617 15.8098H6.81339V20.8331H18.4151V15.8097H20.0661V22.5H5.1617V15.8098ZM8.46445 17.4771H16.7421V19.1441H8.46451L8.46445 17.4771Z" />
                            </svg>
