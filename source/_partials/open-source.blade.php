<div id="opensource-section" class="section opensource-section scroll-indicator"
    ...
    <ol class="cards-ctr flex flex-wrap gap-4 md:gap-0 min-h-[500px]">
        ...
        @if (!$page->githubRepos->isEmpty())
            @foreach ($page->githubRepos as $repo)
                <li class="md:p-3 w-full md:w-1/2">
                    <div
                        class="card  group bg-white border border-yellow-800 rounded-md p-4 h-full flex animate-[fadeIn_.5s_ease-out_forwards] hover:animate-[moveUp_.3s_ease-out_forwards] hover:bg-yellow-100 hover:duration-500 hover:shadow-lg dark:border-yellow-200 dark:bg-brown-900 dark:hover:bg-dark">
                        <div class="relative flex flex-col w-full">
                            ...
                            <div class="flex justify-between">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <a href="{{ $repo->getHtmlUrl() }}" target="_blank"
                                ...
                                <!-- downloads -->
                                @if ($repo->getPackagistUrl())
                                    <a href="{{ $repo->getPackagistUrl() }}" target="_blank"
                                        ...
                                        <span class="script-font text-sm">
                                            {{ $repo->getPackagistDownloadsCount() }}
                                        </span>
                                    </a>
                                @endif
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex gap-2 md:gap-5">
                                    ...
                                    <!-- stars -->
                                    <a href="{{ $repo->getHtmlUrl() }}/stargazers" target="_blank"
                                        class="flex items-center gap-1">
                                        ...
                                        <span class="script-font">
                                            {{ $repo->getStargazersCount() }}
                                        </span>
                                    </a>

                                    <!-- forks -->
                                    <a href="{{ $repo->getHtmlUrl() }}/forks" target="_blank"
                                        class="flex items-center gap-1">
                                        <svg class="fill-yellow-800 dark:fill-yellow-200 w-4 h-4"
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16"
                                            height="16">
