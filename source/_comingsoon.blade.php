...
@section('body')
    <div class="relative bg-glass bg-no-repeat bg-fit flex justify-center items-center h-full">
        <div class="flex flex-col justify-center items-center text-yellow-800">
            ...
            <h1 class="text-xl sm:text-3xl font-medium">amranich.dev</h1>

            <p class="text-3xl py-2 script-font text-center tracking-wide sm:text-6xl sm:py-4 select-none">
                I am almost there!
            </p>

            <div class="flex flex-col items-start sm:flex-row sm:space-x-8 select-none">
                <a class="group flex items-center gap-2 tracking-wide font-light hover:text-yellow-600 transition-all duration-300"
                    href="{{ $page->links->github }}" target="_blank">
                    GitHub
                    <svg class="w-3 stroke-current transform group-hover:translate-x-1 transition-transform duration-300"
                ...
                <a class="group flex items-center gap-2 tracking-wide font-light hover:text-yellow-600 transition-all duration-300"
                    href="{{ $page->links->linkedin }}" target="_blank">
                    Linkedin
                    <svg class="w-3 stroke-current transform group-hover:translate-x-1 transition-transform duration-300"
                        viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.833008 7H12.1663M7.20801 1.16797L12.1663 7.0013L7.20801 12.8346" stroke-width="1.5"
                ...
                <a class="group flex items-center gap-2 tracking-wide font-light hover:text-yellow-600 transition-all duration-300"
                    href="{{ $page->links->behance }}" target="_blank">
                    Behance
                    <svg class="w-3 stroke-current transform group-hover:translate-x-1 transition-transform duration-300"
                        viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.833008 7H12.1663M7.20801 1.16797L12.1663 7.0013L7.20801 12.8346" stroke-width="1.5"
        ...
        <span
            class="absolute text-sm bottom-4 tracking-widest-x2 font-medium flex items-center gap-2 lg:bottom-6 sm:right-8 text-yellow-800">
            ...
            <a class="hover:text-yellow-600 hover:underline transition-all duration-300" href="mailto:{{ $page->email }}">
                {{ $page->email }}
            </a>
        </span>
    </div>
